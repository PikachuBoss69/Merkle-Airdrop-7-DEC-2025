...
contract ClaimAirdrop is Script {
    ...
    uint256 private constant CLAIMING_PRIVATE_KEY =
    ...
    function claimAirdrop(address airdrop) public {
        ...
        // CHANGE: Get EIP-712 hash from contract FIRST (before broadcast)
        ...
        //  CHANGE: Sign the hash we got from the contract
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(
            CLAIMING_PRIVATE_KEY,
            messageHash
        );
